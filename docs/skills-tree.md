...
│   │   ├── shader-dev: Shader 开发
│   │   ├── slack-gif-creator: Slack GIF 制作
│   │   ├── vision-analysis: 视觉分析
│   │   └── youtube-downloader: YouTube 下载器
│   │
│   ├── 🤝 HR人力资源/                             (38 skills)
│   │   ├── HR系统集成/
...
│   │
│   ├── 🔧 skill管理/                              (7 skills)
│   │   ├── darwin-skill-master: 达尔文 Skill 优化器
│   │   ├── github-to-skills: GitHub 转 Skill 工厂
│   │   ├── mcp-builder: MCP 构建器
│   │   ├── skill-creator: Skill 创建器
│   │   ├── skill-evolution-manager: Skill 演进管理器
...
│   │       ├── find-community: 寻找社区
│   │       ├── first-customers: 首批 100 客户
│   │       ├── grow-sustainably: 可持续增长
│   │       ├── marketing-plan: 极简营销计划
│   │       ├── minimalist-review: 极简主义评审
│   │       ├── mvp: 最小可行产品
│   │       ├── pricing: 定价策略
│   │       ├── processize: 流程化
│   │       └── validate-idea: 验证创意
...
│   │   │   ├── wecomcli-edit-todo: 编辑待办
│   │   │   ├── wecomcli-get-meeting: 查询会议
│   │   │   ├── wecomcli-get-msg: 获取消息
│   │   │   ├── wecomcli-get-todo-detail: 待办详情
│   │   │   ├── wecomcli-get-todo-list: 待办列表
│   │   │   ├── wecomcli-lookup-contact: 通讯录查询
│   │   │   ├── wecomcli-manage-doc: 文档管理
│   │   │   ├── wecomcli-manage-schedule: 日程管理
│   │   │   ├── wecomcli-manage-smartsheet-data: 智能表格数据
│   │   │   └── wecomcli-manage-smartsheet-schema: 智能表格结构
│   │   ├── 钉钉/
│   │   │   └── dws: 钉钉工作台
│   │   └── 飞书/
│   │
│   ├── 🎭 名人传记/                               (4 skills)
│   │   ├── colleague-skill: 同事技能
│   │   ├── mao-zedong-perspective: 毛泽东视角
│   │   ├── qiqing-liuyu: 七情六欲
│   │   └── yupi-skill: 程序员鱼皮
│   │
│   ├── 🎨 图形处理/                               (3 skills)
...
│   │   └── fireworks-tech-graph: 技术架构图生成器
│   │
│   ├── 🖌️ 排版设计/                               (5 skills)
│   │   ├── brand-guidelines: 品牌规范
│   │   ├── canvas-design: 画布设计
│   │   ├── color-font-skill: 配色与字体
│   │   ├── design-style-skill: 设计风格
│   │   └── theme-factory: 主题工厂
│   │
│   ├── 📄 文档处理/                              (15 skills)
│   │   ├── csv-data-summarizer: CSV 数据汇总
...
│   │   ├── pdf: PDF 处理
│   │   ├── ppt-editing-skill: PPT 编辑
│   │   ├── ppt-orchestra-skill: PPT 编排
│   │   ├── pptx: PPTX 处理
│   │   ├── pptx-generator: PPTX 生成器
│   │   ├── slide-making-skill: 幻灯片制作
│   │   └── xlsx: Excel 处理
│   │
│   ├── 📢 新媒体运营/                            (63 skills)
│   │   ├── SEO与流量/
...
│   │   │   ├── code-review-zh: 代码审查（中文）
│   │   │   ├── finishing-a-development-branch: 完成开发分支
│   │   │   ├── receiving-code-review: 接受代码审查
│   │   │   ├── requesting-code-review: 请求代码审查
│   │   │   ├── riper-5-mode: RIPER 5 阶段协议
│   │   │   ├── sdd-development-standard: SDD 开发规范
│   │   │   ├── sdd-riper-one: SDD RIPER One
│   │   │   ├── sdd-riper-one-light: SDD RIPER One 轻量版
...
│   │
│   ├── 🎮 网络游戏/                               (1 skill)
│   │   └── kk-ranking-collector: KK 排行榜采集
│   │
│   ├── 🕷️ 网络爬虫工具/                          (13 skills)
│   │   ├── firecrawl: Firecrawl
│   │   ├── firecrawl-agent: Firecrawl Agent
│   │   ├── firecrawl-build-interact: Firecrawl 交互集成
│   │   ├── firecrawl-build-onboarding: Firecrawl 接入配置
│   │   ├── firecrawl-build-scrape: Firecrawl 页面抓取集成
│   │   ├── firecrawl-build-search: Firecrawl 搜索集成
│   │   ├── firecrawl-crawl: Firecrawl 站点爬取
│   │   ├── firecrawl-download: Firecrawl 站点下载
│   │   ├── firecrawl-interact: Firecrawl 页面交互
│   │   ├── firecrawl-map: Firecrawl 站点地图
│   │   ├── firecrawl-parse: Firecrawl 文件解析
│   │   ├── firecrawl-scrape: Firecrawl 页面抓取
│   │   └── firecrawl-search: Firecrawl 搜索
│   │
│   └── 📋 行政文员/                               (5 skills)
│       ├── create-lecture: 课件制作
│       ├── data-analysis: 数据分析
