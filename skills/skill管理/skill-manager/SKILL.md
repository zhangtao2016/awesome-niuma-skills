...
1.  **Audit**: Scans your local skills folder for skills with `update_url` metadata.
...
- `scripts/list_skills.py`: Lists all installed skills with type, version, license and update_url.
